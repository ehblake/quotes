...
MANUAL_CONNECTIONS = {
    ...
    'ethics': {'values': 4.2, 'goodness': 4.0, 'honesty': 3.8, 'truth': 3.5, 'philosophy': 3.2},
    ...
    'goodness': {'values': 4.0, 'ethics': 3.8, 'truth': 3.5},
    'information': {'knowledge': 4.0, 'media': 3.8, 'technology': 3.5, 'truth': 3.0},
    'interpretation': {'meaning': 4.0, 'storytelling': 3.8, 'understanding': 3.5, 'reading': 3.2},
    ...
    'chaos': {'entropy': 4.0, 'destruction': 3.8, 'death': 3.5, 'danger': 3.2},
    ...
    'comfort': {'calmness': 4.0, 'pleasure': 3.8, 'happiness': 3.5},
    'disaster': {'destruction': 4.2, 'chaos': 4.0, 'doom': 3.8, 'death': 3.5, 'danger': 3.2},
    'making': {'process': 3.8, 'work': 3.5, 'life': 3.2},
    ...
    'pain': {'torture': 3.8, 'emotion': 3.5, 'life': 3.2, 'death': 3.0},
...
ALLOWED_PRIMARY_TAGS = {
    ...
    'revolution', 'ruin', 'rules', 'sadness', 'science',
    'seeing', 'the sea', 'the self', 'the senses', 'serendipity', 'simplicity',
    'simplification', 'society', 'songs', 'spirit',
